...
mod test {
    ...
    const KIMCHI_PROOF: &[u8] = include_bytes!("../../../../prover_examples/kimchi/example/kimchi_ec_add.proof");
    const KIMCHI_VERIFIER_INDEX: &[u8] = include_bytes!("../../../../prover_examples/kimchi/example/kimchi_verifier_index_example.bin");
