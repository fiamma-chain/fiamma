...
var (
	...
	fd_StakerInfo_staker_register_id protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_StakerInfo_staker_register_id = md_StakerInfo.Fields().ByName("staker_register_id")
}
...
func (x *fastReflection_StakerInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.StakerRegisterId != uint64(0) {
		...
		if !f(fd_StakerInfo_staker_register_id, value) {
			return
		}
	}
}
...
func (x *fastReflection_StakerInfo) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fiamma.bitvmstaker.StakerInfo.staker_register_id":
...
func (x *fastReflection_StakerInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fiamma.bitvmstaker.StakerInfo.staker_register_id":
		panic(fmt.Errorf("field staker_register_id of message fiamma.bitvmstaker.StakerInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fiamma.bitvmstaker.StakerInfo"))
		}
...
func (x *StakerInfo) GetStakerRegisterId() uint64 {
	if x != nil {
...
var file_fiamma_bitvmstaker_bitvmstaker_proto_rawDesc = []byte{
	...
	,
