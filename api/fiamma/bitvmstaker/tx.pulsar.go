...
var (
	...
	fd_MsgCreateStaker_stakerAddress protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgCreateStaker_stakerAddress = md_MsgCreateStaker.Fields().ByName("stakerAddress")
}
...
func (x *fastReflection_MsgCreateStaker) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.StakerAddress != "" {
		...
		if !f(fd_MsgCreateStaker_stakerAddress, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgCreateStaker) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fiamma.bitvmstaker.MsgCreateStaker.creator":
		return x.Creator != ""
	case "fiamma.bitvmstaker.MsgCreateStaker.stakerAddress":
...
func (x *fastReflection_MsgCreateStaker) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fiamma.bitvmstaker.MsgCreateStaker.stakerAddress":
		panic(fmt.Errorf("field stakerAddress of message fiamma.bitvmstaker.MsgCreateStaker is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fiamma.bitvmstaker.MsgCreateStaker"))
		}
...
var file_fiamma_bitvmstaker_tx_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x5f,
	...
	0x28, 0x09, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x24, 0x0a, 0x0d, 0x73,
	0x74, 0x61, 0x6b, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd0, 0x01, 0x0a, 0x03, 0x4d,
	0x73, 0x67, 0x12, 0x60, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61,
	0x6d, 0x73, 0x12, 0x23, 0x2e, 0x66, 0x69, 0x61, 0x6d, 0x6d, 0x61, 0x2e, 0x62, 0x69, 0x74, 0x76,
	0x6d, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x72, 0x2e, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x1a, 0x2b, 0x2e, 0x66, 0x69, 0x61, 0x6d, 0x6d, 0x61,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x60, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74,
	...
	0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x72, 0x1a, 0x2b, 0x2e, 0x66, 0x69, 0x61, 0x6d,
	0x6d, 0x61, 0x2e, 0x62, 0x69, 0x74, 0x76, 0x6d, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x72, 0x2e, 0x4d,
	0x73, 0x67, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x72, 0x52, 0x65,
...
var file_fiamma_bitvmstaker_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_fiamma_bitvmstaker_tx_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                  // 4: fiamma.bitvmstaker.Params
}
var file_fiamma_bitvmstaker_tx_proto_depIdxs = []int32{
	4, // 0: fiamma.bitvmstaker.MsgUpdateParams.params:type_name -> fiamma.bitvmstaker.Params
	...
	1, // 3: fiamma.bitvmstaker.Msg.UpdateParams:output_type -> fiamma.bitvmstaker.MsgUpdateParamsResponse
	3, // 4: fiamma.bitvmstaker.Msg.CreateStaker:output_type -> fiamma.bitvmstaker.MsgCreateStakerResponse
