...
var (
	...
	fd_MsgSlashStaker_staker_adress protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgSlashStaker_staker_adress = md_MsgSlashStaker.Fields().ByName("staker_adress")
}
...
func (x *fastReflection_MsgSlashStaker) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.StakerAdress != "" {
		value := protoreflect.ValueOfString(x.StakerAdress)
		if !f(fd_MsgSlashStaker_staker_adress, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgSlashStaker) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fiamma.bitvmstaker.MsgSlashStaker.creator":
		return x.Creator != ""
	case "fiamma.bitvmstaker.MsgSlashStaker.staker_adress":
		return x.StakerAdress != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgSlashStaker) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "fiamma.bitvmstaker.MsgSlashStaker.creator":
		x.Creator = value.Interface().(string)
	case "fiamma.bitvmstaker.MsgSlashStaker.staker_adress":
		x.StakerAdress = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fiamma.bitvmstaker.MsgSlashStaker"))
		}
...
func (x *fastReflection_MsgSlashStaker) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fiamma.bitvmstaker.MsgSlashStaker.staker_adress":
		panic(fmt.Errorf("field staker_adress of message fiamma.bitvmstaker.MsgSlashStaker is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fiamma.bitvmstaker.MsgSlashStaker"))
		}
...
func (x *fastReflection_MsgSlashStaker) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.StakerAdress) > 0 {
			i -= len(x.StakerAdress)
			copy(dAtA[i:], x.StakerAdress)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.StakerAdress)))
			i--
			dAtA[i] = 0x12
		}
		if len(x.Creator) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field StakerAdress", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.StakerAdress = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
type MsgSlashStaker struct {
	...
	Creator      string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	StakerAdress string `protobuf:"bytes,2,opt,name=staker_adress,json=stakerAdress,proto3" json:"staker_adress,omitempty"`
}
...
func (x *MsgSlashStaker) GetStakerAdress() string {
	if x != nil {
		return x.StakerAdress
	}
	return ""
...
var file_fiamma_bitvmstaker_tx_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x5d, 0x0a, 0x0e, 0x4d,
	...
	,
}
...
var file_fiamma_bitvmstaker_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_fiamma_bitvmstaker_tx_proto_depIdxs = []int32{
	6, // 0: fiamma.bitvmstaker.MsgUpdateParams.params:type_name -> fiamma.bitvmstaker.Params
	...
	1, // 4: fiamma.bitvmstaker.Msg.UpdateParams:output_type -> fiamma.bitvmstaker.MsgUpdateParamsResponse
	3, // 5: fiamma.bitvmstaker.Msg.CreateStaker:output_type -> fiamma.bitvmstaker.MsgCreateStakerResponse
	5, // 6: fiamma.bitvmstaker.Msg.SlashStaker:output_type -> fiamma.bitvmstaker.MsgSlashStakerResponse
