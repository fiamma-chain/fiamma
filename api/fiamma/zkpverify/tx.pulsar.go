...
var (
	...
	fd_MsgSendTask_proofSystem protoreflect.FieldDescriptor
	fd_MsgSendTask_proof       protoreflect.FieldDescriptor
	fd_MsgSendTask_publicInput protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgSendTask_proofSystem = md_MsgSendTask.Fields().ByName("proofSystem")
	fd_MsgSendTask_proof = md_MsgSendTask.Fields().ByName("proof")
	fd_MsgSendTask_publicInput = md_MsgSendTask.Fields().ByName("publicInput")
...
func (x *fastReflection_MsgSendTask) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ProofSystem != "" {
		...
		if !f(fd_MsgSendTask_proofSystem, value) {
			return
		}
	}
	if len(x.Proof) != 0 {
	...
	if len(x.PublicInput) != 0 {
		...
		if !f(fd_MsgSendTask_publicInput, value) {
			return
		}
	}
	if len(x.Vk) != 0 {
...
func (x *fastReflection_MsgSendTask) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fiamma.zkpverify.MsgSendTask.creator":
		return x.Creator != ""
	case "fiamma.zkpverify.MsgSendTask.proofSystem":
		return x.ProofSystem != ""
	case "fiamma.zkpverify.MsgSendTask.proof":
		return len(x.Proof) != 0
	case "fiamma.zkpverify.MsgSendTask.publicInput":
...
func (x *fastReflection_MsgSendTask) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fiamma.zkpverify.MsgSendTask.proofSystem":
		panic(fmt.Errorf("field proofSystem of message fiamma.zkpverify.MsgSendTask is not mutable"))
	case "fiamma.zkpverify.MsgSendTask.proof":
		panic(fmt.Errorf("field proof of message fiamma.zkpverify.MsgSendTask is not mutable"))
	case "fiamma.zkpverify.MsgSendTask.publicInput":
		panic(fmt.Errorf("field publicInput of message fiamma.zkpverify.MsgSendTask is not mutable"))
	case "fiamma.zkpverify.MsgSendTask.vk":
...
var (
	...
	fd_MsgSendTaskResponse_proofCommitment protoreflect.FieldDescriptor
	fd_MsgSendTaskResponse_verifyResult    protoreflect.FieldDescriptor
)

func init() {
	file_fiamma_zkpverify_tx_proto_init()
	md_MsgSendTaskResponse = File_fiamma_zkpverify_tx_proto.Messages().ByName("MsgSendTaskResponse")
	fd_MsgSendTaskResponse_proofCommitment = md_MsgSendTaskResponse.Fields().ByName("proofCommitment")
	fd_MsgSendTaskResponse_verifyResult = md_MsgSendTaskResponse.Fields().ByName("verifyResult")
}
...
func (x *fastReflection_MsgSendTaskResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.ProofCommitment) != 0 {
		...
		if !f(fd_MsgSendTaskResponse_proofCommitment, value) {
			return
		}
	}
	if x.VerifyResult != uint64(0) {
		value := protoreflect.ValueOfUint64(x.VerifyResult)
		if !f(fd_MsgSendTaskResponse_verifyResult, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgSendTaskResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fiamma.zkpverify.MsgSendTaskResponse.proofCommitment":
		return len(x.ProofCommitment) != 0
	case "fiamma.zkpverify.MsgSendTaskResponse.verifyResult":
		return x.VerifyResult != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgSendTaskResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fiamma.zkpverify.MsgSendTaskResponse.proofCommitment":
		panic(fmt.Errorf("field proofCommitment of message fiamma.zkpverify.MsgSendTaskResponse is not mutable"))
	case "fiamma.zkpverify.MsgSendTaskResponse.verifyResult":
		panic(fmt.Errorf("field verifyResult of message fiamma.zkpverify.MsgSendTaskResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fiamma.zkpverify.MsgSendTaskResponse"))
		}
...
func (x *fastReflection_MsgSendTaskResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.VerifyResult != 0 {
			n += 1 + runtime.Sov(uint64(x.VerifyResult))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.VerifyResult != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.VerifyResult))
			i--
			dAtA[i] = 0x10
		}
		if len(x.ProofCommitment) > 0 {
		...
		for iNdEx < l {
			...
			case 2:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.VerifyResult |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
type MsgSendTask struct {
	...
	ProofSystem string `protobuf:"bytes,2,opt,name=proofSystem,proto3" json:"proofSystem,omitempty"`
	Proof       []byte `protobuf:"bytes,3,opt,name=proof,proto3" json:"proof,omitempty"`
	PublicInput []byte `protobuf:"bytes,4,opt,name=publicInput,proto3" json:"publicInput,omitempty"`
...
type MsgSendTaskResponse struct {
	...
	ProofCommitment []byte `protobuf:"bytes,1,opt,name=proofCommitment,proto3" json:"proofCommitment,omitempty"`
	VerifyResult    uint64 `protobuf:"varint,2,opt,name=verifyResult,proto3" json:"verifyResult,omitempty"`
}
...
func (x *MsgSendTaskResponse) GetProofCommitment() []byte {
	if x != nil {
...
func (x *MsgSendTaskResponse) GetVerifyResult() uint64 {
	if x != nil {
...
var file_fiamma_zkpverify_tx_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9f, 0x01, 0x0a, 0x0b, 0x4d, 0x73, 0x67, 0x53, 0x65, 0x6e, 0x64,
	...
	0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x18, 0x02, 0x20,
	...
	0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x20, 0x0a, 0x0b, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63,
	0x49, 0x6e, 0x70, 0x75, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x70, 0x75, 0x62,
	0x6c, 0x69, 0x63, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x76, 0x6b, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x76, 0x6b, 0x3a, 0x0c, 0x82, 0xe7, 0xb0, 0x2a, 0x07, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x63, 0x0a, 0x13, 0x4d, 0x73, 0x67, 0x53, 0x65, 0x6e,
	...
	,
	...
	0x69, 0x66, 0x79, 0x42, 0x07, 0x54, 0x78, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x21,
