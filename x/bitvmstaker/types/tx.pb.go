...
func (m *MsgSlashStaker) GetStakerAdress() string {
	if m != nil {
		return m.StakerAdress
	}
	return ""
}
...
var fileDescriptor_ca62a47b6be03f96 = []byte{
	...
	,
}
...
func (m *MsgSlashStaker) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.StakerAdress) > 0 {
		i -= len(m.StakerAdress)
		copy(dAtA[i:], m.StakerAdress)
		i = encodeVarintTx(dAtA, i, uint64(len(m.StakerAdress)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
...
func (m *MsgSlashStaker) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StakerAdress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StakerAdress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
