...
var fileDescriptor_34020df3ad9f3bf1 = []byte{
	...
	0x0c, 0x17, 0x27, 0x98, 0x19, 0x52, 0x59, 0x90, 0x2a, 0xc1, 0x0c, 0x96, 0x43, 0x08, 0x08, 0x29,
	0x70, 0x71, 0x83, 0x39, 0xc1, 0x25, 0x89, 0x25, 0xa5, 0xc5, 0x12, 0x2c, 0x0a, 0x8c, 0x1a, 0x2c,
	0x41, 0xc8, 0x42, 0x4e, 0x06, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0, 0x91,
	...
	0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x55, 0xd6, 0x21, 0xac, 0xe7, 0x00, 0x00, 0x00,
}
...
func (m *Zkproof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ProofType) > 0 {
		...
		i = encodeVarintZkproof(dAtA, i, uint64(len(m.ProofType)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ProofId) > 0 {
